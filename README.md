# postcss-px-to-viewport-8-media
在[postcss-px-to-viewport-8-plugin](https://github.com/lkxian888/postcss-px-to-viewport-8-plugin)的基础上拓展了```mediaOptions```配置, 使得不同视口可以使用不同的```viewportWidth```进行打包。
